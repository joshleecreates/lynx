...
config :lynx, LynxWeb.Endpoint,
  ...
  live_view: [signing_salt: "T5xLsARd"]
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.jsx --bundle --target=es2017 --outdir=../priv/static/assets --external:/node_modules/react-bulma-components --external:/fonts/* --external:/images/*),
